...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware',  # Debe ir ANTES del middleware de traducción
    ...
    'apps.base.middlewares.translation_middleware.AutoTranslationMiddleware', # Se agrego para poder realizar el cambio de thema {% load i18n %}
...
# Configuración simplificada para el traductor
TRANSLATOR_SERVICE = 'microsoft'  # Usa el servicio gratuito de Microsoft

# Configuración de LibreTranslate (servicio gratuito)
LIBRE_TRANSLATE_URL = 'https://translate.argosopentech.com'  # Instancia pública gratuita
LIBRE_TRANSLATE_API_KEY = None  # No es necesaria para instancias públicas
...
# Configuración del middleware de traducción automática
AUTO_TRANSLATION = {
    'CACHE_TIMEOUT': 86400,  # 24 horas en segundos
    'EXCLUDED_PATHS': ['/admin/', '/api/'],  # Rutas que no se traducirán
    'EXCLUDED_APPS': ['admin'],  # Aplicaciones que no se traducirán
}
